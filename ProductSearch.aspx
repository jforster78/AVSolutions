<%@ Page Title="Product Search" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductSearch.aspx.cs" Inherits="AvSolutions.ProductSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:FormView ID="productSearch" runat="server" ItemType="AvSolutions.Models.Product" SelectMethod ="GetProductSearch" RenderOuterTable="false">
        <ItemTemplate>
            <div>
            ...
            <table><!-- Creates a table -->
                <tr><!-- This is a table row -->
                    ...
                    <td style="vertical-align: top; text-align:left;"><!-- This is used for table data -->
                        ...
                        <br /><!-- Line break -->
                        <strong class="ProductListItem">Add To Cart<strong><!-- This will display the Add To Cart text in bold using the class ProductListItem within the CSS -->
